...
Replace `YOUR_ORG` with your GitHub user or organisation.
...
git branch -M main
git remote add origin https://github.com/YOUR_ORG/peppol-package-laravel.git
...
git branch -M main
git remote add origin https://github.com/YOUR_ORG/peppol-package-demo.git
git push -u origin main
```
...
git branch -M main
git remote add origin https://github.com/YOUR_ORG/peppol-package-landingpage.git
git push -u origin main
```

## Packagist

After the package repo is public, submit `https://github.com/YOUR_ORG/peppol-package-laravel` on [packagist.org](https://packagist.org). See `PUBLISH.md`.
